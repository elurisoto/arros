...
class ArduinoROS():
    def __init__(self):
        ...
        # A service to request values from the compass
        # rospy.Service('~compass_read', CompassRead, self.CompassReadHandler)
        ...
        for name, params in sensor_params.iteritems():
            ...
            elif params['type'] == 'Compass':
                sensor = Compass(self.controller, name, params['pin'], params['rate'], self.base_frame)
            elif params['type'] == 'LineFollower':
                sensor = LineFollower(self.controller, name, params['pin'], params['rate'], self.base_frame)
            elif params['type'] == 'MultiSonar':
                sensor = MultiSonar(self.controller, name, params['pin'], params['rate'], self.base_frame)
