...
if("FALSE" STREQUAL "TRUE")
  set(ros_arduino_firmware_SOURCE_PREFIX /home/elu/Dropbox/PFG/catkin_ws/src/ros_arduino_bridge/ros_arduino_firmware)
  set(ros_arduino_firmware_DEVEL_PREFIX /home/elu/Dropbox/PFG/catkin_ws/src/devel)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/elu/Dropbox/PFG/catkin_ws/devel/lib;/opt/ros/hydro/lib)
